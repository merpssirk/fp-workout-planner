        ...
        {currentWorkout ? (
          <div className={styles.mainContainer}>
            ...
            <div className={styles.exerciseContainer}>
              <div className={styles.exerciseDiv}>
                <div className={styles.exerciseImg}>
                  <h4>{!currentWorkout[4] ? null : currentWorkout[4][0]}</h4>
                  <ul>
                    <li>
                      Body Part-:{" "}
                      <b>{!currentWorkout[4] ? null : currentWorkout[4][1]}</b>
                    </li>
                    <li>
                      Sets-:{" "}
                      <b>{!currentWorkout[4] ? null : currentWorkout[4][2]}</b>
                    </li>
                    <li>
                      Repetitions:{" "}
                      <b>{!currentWorkout[4] ? null : currentWorkout[4][3]}</b>
                    </li>
                  </ul>
                </div>
              </div>
              <div className={styles.exerciseDiv}>
                <div className={styles.exerciseImg}>
                  <h4>{!currentWorkout[5] ? null : currentWorkout[5][0]}</h4>
                  <ul>
                    <li>
                      Body Part-:{" "}
                      <b>{!currentWorkout[5] ? null : currentWorkout[5][1]}</b>
                    </li>
                    <li>
                      Sets-:{" "}
                      <b>{!currentWorkout[5] ? null : currentWorkout[5][2]}</b>
                    </li>
                    <li>
                      Repetitions:{" "}
                      <b>{!currentWorkout[5] ? null : currentWorkout[5][3]}</b>
                    </li>
                  </ul>
                </div>
              </div>
              <div className={styles.exerciseDiv}>
                <div className={styles.exerciseImg}>
                  <h4>{!currentWorkout[6] ? null : currentWorkout[6][0]}</h4>
                  <ul>
                    <li>
                      Body Part-:{" "}
                      <b>{!currentWorkout[6] ? null : currentWorkout[6][1]}</b>
                    </li>
                    <li>
                      Sets-: <b></b>
                    </li>
